...
crank_x2 = o2_x + crank_length * sind(crank_angle(i));
crank_x3 = o3_x + crank_length * sind(crank_angle(i));
crank_x4 = o4_x + crank_length * sind(crank_angle(i));

crank_y1 = o1_y + crank_length * cosd(crank_angle(i));
crank_y2 = o2_y + crank_length * cosd(crank_angle(i));
crank_y3 = o3_y + crank_length * cosd(crank_angle(i));
...
coupler_y2 = o2_y + s_length0(i);
coupler_y3 = o3_y + s_length0(i);
